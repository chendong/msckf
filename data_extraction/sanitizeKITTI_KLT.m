...
dataBaseDir = 'C:/Users/pang/Downloads/2011_09_26_drive_0009_sync/2011_09_26/2011_09_26_drive_0009_sync';
dataCalibDir = 'C:/Users/pang/Downloads/2011_09_26_drive_0009_sync/2011_09_26/2011_09_26_drive_0009_sync/';
...
a_vk_vk_i = imuData.measAccel;
v_init    = imuData.initialVelocity;  
...
fileName = [char(f(1)) '_a_KLT.mat'];
save(['../datasets2/' fileName], 'r_i_vk_i','theta_vk_i','w_vk_vk_i','v_vk_vk_i', 'a_vk_vk_i','v_init','cu','cv','fu','fv','b', 'y_k_j', 'C_c_v', 'rho_v_c_v', 't');
...
figure
plot(imuData.measAccel(1, :))
hold on
plot(imuData.measAccel(2, :))
plot(imuData.measAccel(3, :))
% 
% figure 
% subplot(2,2,1)
% hist(imuData(1, :), 50)
